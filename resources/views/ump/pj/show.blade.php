            ...
            <div class="card card-custom">
                <div class="card-body p-8">
                    <div class="row">
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group row">
                                <label class="col-sm-12 col-md-4 col-form-label">{{ __('No PJ UMP') }}</label>
                                <div class="col-sm-12 col-md-8 parent-group">
                                    <input type="text" name="id_pj_ump" class="form-control" placeholder="{{ __('No PJ UMP') }}"
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-10 parent-group">
                                    <textarea name="uraian" type="text" class="form-control" placeholder="{{ __('Uraian') }}" rows="3" disabled>{!! $record->uraian !!}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-12">
                            <div class="form-group row">
                                <label class="col-sm-12 col-md-2  col-form-label">{{ __('Lampiran PJ UMP') }}</label>
                                <div class="col-sm-12 col-md-10  parent-group">
