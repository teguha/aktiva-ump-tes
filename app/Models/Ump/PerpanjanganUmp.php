...
class PerpanjanganUmp extends Model
{
    use HasFiles, HasApprovals;

    protected $table = 'trans_ump_perpanjangan';

    protected $fillable = [
        'pengajuan_ump_id',
        'id_ump_perpanjangan',
        'tgl_ump_perpanjangan',
        'tgl_perpanjangan_pembayaran',
        'uraian',
        'status',
    ];
     ...
     ** MUTATOR
     *******************************/
    public function setTglUmpPerpanjanganAttribute($value)
    {
        $this->attributes['tgl_ump_perpanjangan'] = Carbon::createFromFormat('d/m/Y', $value);
    }
    public function setTglPerpanjanganPembayaranAttribute($value)
    {
        $this->attributes['tgl_perpanjangan_pembayaran'] = Carbon::createFromFormat('d/m/Y', $value);
    }

    /*******************************
     ** ACCESSOR
     *******************************/
    public function getShowTglPerpanjanganAttribute()
    {
        return Carbon::parse($this->tgl_perpanjangan)->format('d/m/Y');
    }
    /*******************************
     ** RELATION
     *******************************/
    ...
    public function handleStoreOrUpdate($request)
    {
        ...
        try {
            ...
            $this->status = 'draft';
            $this->save();
            $this->saveFilesByTemp($request->uploads, 'ump.perpanjangan-ump', 'uploads');
            $this->saveLogNotify();
