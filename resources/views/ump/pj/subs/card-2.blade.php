        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-md-8 parent-group">
                <select class="form-control base-plugin--select2-ajax" name="ref_org_struct_id" {{ in_array($page_action,
                    ...
                    <option value="{{ $pengajuan->aktiva->struct_id }}" selected {{ in_array($page_action, ['show', 'approval' ]) }}>{{
                        $pengajuan->aktiva->getStructName() }}</option>
                </select>
            </div>
        </div>
    </div>
...
<div class="row">
    <div class="col-sm-12 col-md-12">
        <div class="form-group row">
            <label class="col-sm-12 col-md-2 col-form-label">{{ __('PIC Staff Unit Kerja') }}</label>
...
<div class="row">
    <div class="col-sm-12 col-md-12">
        <div class="form-group row">
            <label class="col-sm-12 col-md-2 col-form-label">{{ __('Kepala Departemen Terkait') }}</label>
            <div class="col-sm-12 col-md-4 parent-group">
                <input type="text" name="code" class="form-control" placeholder="{{ __('NIK') }}"
