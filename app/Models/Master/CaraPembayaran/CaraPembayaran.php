...
namespace App\Models\Master\CaraPembayaran;
...
class CaraPembayaran extends Model
{
    ...
    public $table = "cara_pembayaran";

    public $fillable = [
        "id", "nama", "created_by", "updated_by", "created_at", "updated_at"
    ];
    ...
    public function pengajuan_aktiva() {
        return $this->hasMany(PengajuanPembelianAktiva::class, 'cara_pembayaran_id', 'id');
    }
    ...
    {
        if($this->pengajuan_aktiva->count()){
            return false;
        }
