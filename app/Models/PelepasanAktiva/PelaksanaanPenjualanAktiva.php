...
class PelaksanaanPenjualanAktiva extends Model
{
    use HasFiles, HasApprovals;

    protected $table = 'trans_pelaksanaan_penjualan_aktiva';
    ...
    function pengajuan()
    {
        return $this->belongsTo(PenjualanPembelianAktiva::class, 'penjualan_aktiva_id');
    }
