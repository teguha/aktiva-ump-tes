                        ...
                        <div class="pull-right">
                            <div class="btn-group dropup">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <button type="submit" class="dropdown-item align-items-center base-form--submit-page" data-submit="1" data-swal-title="Submit Pengajuan Termin {{ $record->aktiva->code }} ?">
