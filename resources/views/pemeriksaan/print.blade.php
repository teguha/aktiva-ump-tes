        ...
        <table style="border:none; width:100%;">
            <tr>
                <td style="border:none; width:45%;">
                    <table style="border:none; width:100%;">
                        <tr>
                            <td style="border: none; width: 100px;">{{ __('Id Pemeriksaan') }}</td>
                        ...
                        <tr>
                            <td style="border: none; vertical-align: top; width: 100px;">{{ __('Pemeriksa') }}</td>
                            <td style="border: none; vertical-align: top; width: 10px; text-align: left;">:</td>
                            <td style="border: none; text-align: left;">
                                @foreach ($record->pemeriksa as $pemeriksa)
                                    {{ $loop->iteration }}. {{ $pemeriksa->name }} <br>
                                @endforeach
                            </td>
                        </tr>
                        <tr>
                            <td style="border: none; width: 100px;">{{ __('Keterangan') }}</td>
                            <td style="border: none; width: 10px; text-align: left;">:</td>
                            <td style="border: none; text-align: left;">{{ $record->description }}</td>
                        </tr>
                    </table>
                </td>
                <td style="border:none; width:55%; text-align:right; float:right; position:relative; ">
                    <table style="border:none; width:100%;  position: relative; float:right;  width: auto !important;">
                        <tr>
                            <td style="border: none; width: 150px;">{{ __('Tgl Pemeriksaan') }}</td>
                            <td style="border: none; width: 10px; text-align: left;">:</td>
            ...
            @foreach ($record->details()->orderBy('created_at', 'DESC')->orderBy('updated_at', 'DESC')->get() as $detail)
                <li>
                    <table style="border: none; width: 100%">
                        ...
                        <tr>
                            <td style="border: none;vertical-align: top; width: 170px;">{{ __('Kondisi') }}</td>
                            <td style="border: none; vertical-align: top; width: 10px;">:</td>
                            <td style="border: none;">
                                <div class="wysiwyg-content">{!! $detail->condition !!}</div>
                            </td>
                        </tr>
                        <tr>
                            <td style="border: none;vertical-align: top; width: 170px;">{{ __('Keterangan') }}</td>
                            <td style="border: none; vertical-align: top; width: 10px;">:</td>
                            <td style="border: none;">
                                <div class="wysiwyg-content">{!! $detail->description !!}</div>
                            </td>
                        </tr>
                        <tr>
                            <td style="border: none;vertical-align: top; width: 170px;">{{ __('Lampiran') }}</td>
                            <td style="border: none; vertical-align: top; width: 10px;">:</td>
                            <td style="border: none;">
