...
<body class="page">
        ...
        <table style="border:none; width: 100%;">
            <tr>
                ...
                <td style="border:none;  text-align: center; font-size: 14pt;" width="auto">
                    <b>{{ __('PEMBATALAN UANG MUKA PEMBAYARAN (UMP)') }}</b>
    ...
    <main>
        ...
        <hr>
        <br>
        <div style="text-align: justify;">Perjanjian pengajuan Pembatalan UMP ini dibuat pada tanggal {{ $record->created_at->translatedFormat('d F Y')}} dengan pengajuan sebagai berikut:</div>
        <br>
        <table style="border: none; width: 100%">
            <tr>
                <td style="border: none;vertical-align: top; width: 170px;">{{ __('No Pembatalan UMP') }}</td>
                <td style="border: none; vertical-align: top; width: 10px;">:</td>
                <td style="border: none;">
                    <div class="wysiwyg-content">
                    {!! $record->id_ump_pembatalan ?? "" !!}
                    </div>
                </td>
            </tr>
            <tr>
                <td style="border: none;vertical-align: top; width: 170px;">{{ __('Tgl Pembatalan Ump') }}</td>
                <td style="border: none; vertical-align: top; width: 10px;">:</td>
                <td style="border: none;">
                    <div class="wysiwyg-content">
                    {{ $record->tgl_ump_pembatalan ?  $record->tgl_ump_pembatalan->format('d/m/Y') : '' }}
                    </div>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="border: none;vertical-align: top; width: 170px;">{{ __('Uraian Pembatalan UMP') }}</td>
                <td style="border: none; vertical-align: top; width: 10px;">:</td>
                <td style="border: none;">
                    <div class="wysiwyg-content">
                    {!! $record->uraian !!}
            ...
            <tr>
                <td style="border: none;vertical-align: top; width: 170px;">{{ __('Lampiran Pembatalan UMP') }}</td>
                <td style="border: none; vertical-align: top; width: 10px;">:</td>
                <td style="border: none;vertical-align: top;">
                    <div class="wysiwyg-content text-justify">
                        <ul style="padding-left: 15px;">
        ...
        <br>
        <div style="text-align: justify;">Demikian pengajuan Pembatalan UMP ini dibuat untuk dipertimbangkan sebaik-baiknya dan penuh tanggung jawab.</div>
        <br><br>
