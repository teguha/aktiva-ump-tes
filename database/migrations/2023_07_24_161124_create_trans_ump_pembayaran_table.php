...
class CreateTransUmpPembayaranTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('trans_ump_pembayaran', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('pengajuan_ump_id');
            $table->string('id_ump_pembayaran')->unique()->nullable();
            $table->date('tgl_ump_pembayaran')->nullable();
    ...
    {
        Schema::dropIfExists('trans_ump_pembayaran');
    }
}
