            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-8 parent-group">
                    <div class="input-group">
                        ...
                        <input type="text"  name="nominal" class="form-control text-right  base-plugin--inputmask_currency nominal-input-currency" placeholder="{{ __('Nominal') }}" value="{{$detail->nominal}}">
                    </div>  
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-8 parent-group">
                    <div class="input-group">
                        ...
                        <input type="text" name="pajak" class="form-control text-right base-plugin--inputmask_currency pajak-input-currency" placeholder="{{ __('Pajak') }}" value="{{$detail->pajak}}">
                    </div> 
                </div>
            </div>
            <div class="form-group row">
