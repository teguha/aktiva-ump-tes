...
@section('card-body')
    ...
    <div class="row mb-3">
        <div class="col-sm-12">
            <div class="card card-custom">
                ...
                <div class="card-body">
                    @csrf
                    @include('operational-cost.subs.card-1')
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row mb-3">
        <div class="col-sm-12">
            <div class="card card-custom">
                <div class="card-header">
                    <h3 class="card-title">Detail Biaya Operasional</h3>
                </div>
                <div class="card-body p-8">
                    @csrf
                    @include('operational-cost.subs.card-3')
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row mb-3">
        <div class="col-sm-12">
            <div class="card card-custom">
                <div class="card-body p-8">
                    @include('operational-cost.subs.card-2')
                </div>
    ...
    <div class="row mt-4">
        ...
        <div class="col-md-6" style="margin-top:20px!important;">
            <div class="card card-custom" style="margin-bottom:0; height:100%;">
                <div class="card-header">
        ...
        <div class="row mb-3">
            <div class="col-sm-12">
                <div class="card card-custom">
                    ...
                    <div class="card-body p-8">
                        @csrf
                        @include('operational-cost.subs.card-3-extra')
                    </div>
                </div>
            </div>
        </div>
