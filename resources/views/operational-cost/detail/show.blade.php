...
@section('modal-body')
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-12 col-md-8 parent-group">
            <input type="text" name="name" data-post="name" class="form-control" placeholder="{{ __('Nama Biaya') }}" value="{{ $detail->name }}" disabled>
        </div>
    </div>
    <div class="form-group row">
        ...
        <div class="col-sm-12 col-md-8 parent-group">
                ...
                placeholder="{{ __('Tgl Pemesanan') }}" value="{{ $detail->tgl_pemesanan->format('d/m/Y') }}" disabled>
        </div>
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-12 col-md-8 parent-group">
            <div class="input-group">
                ...
                <input type="text" name="cost" class="form-control text-right  base-plugin--inputmask_currency" placeholder="{{ __('Biaya') }}" value="{{ $detail->cost}}" disabled>
            </div>
        </div>
    </div>
@endsection
