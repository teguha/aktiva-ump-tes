    ...
    <div class="row">
        <div class="col-sm-12 col-md-6">
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-8 parent-group">
                    <select class="form-control base-plugin--select2-ajax" name="jenis_asset"
                        ...
                        <option value="tangible" {{$detail->jenis_asset == "tangible" ? "selected" : ""}}>Tangible</option>
                        <option value="intangible" {{$detail->jenis_asset == "intangible" ? "selected" : ""}}>Intangible</option>
                    </select>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-8 parent-group">
                    <input type="text" name="nama_aktiva" data-post="nama_aktiva" class="form-control" placeholder="{{ __('Nama Aktiva') }}" value="{{ $detail->nama_aktiva ?? '' }}">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-8 parent-group">
                     <input type="text" name="merk" class="form-control" placeholder="{{ __('Merk') }}" value="{{ $detail->merk ?? '' }}">
                </div>
            </div>
            <div class="form-group row">
                <label class="col-sm-12 col-md-4 col-form-label">{{ __('No. Seri/Tipe') }}</label>
                <div class="col-sm-12 col-md-8 parent-group">
                     <input type="text" name="no_seri" class="form-control" placeholder="{{ __('No. Seri/Tipe') }}" value="{{ $detail->no_seri ?? '' }}">
                </div>
            </div>
            <div class="form-group row">
        ...
        <div class="col-sm-12 col-md-6">
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-8 parent-group">
                    <div class="input-group">
                        <input type="text" name="jumlah_unit_pembelian" class="form-control text-right base-plugin--inputmask_currency" placeholder="{{ __('Jml Unit') }}" value="{{ number_format($detail->jumlah_unit_pembelian,0,',','.')  }}">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-8 parent-group">
                    <div class="input-group">
                        ...
                        <input type="text" name="harga_per_unit" class="form-control text-right  base-plugin--inputmask_currency" placeholder="{{ __('Harga per Unit') }}" value="{{ $detail->harga_per_unit }}">
                    </div>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-8 parent-group">
                    <div class="input-group">
                        ...
                        <input disabled type="text" name="total_harga" class="form-control text-right" placeholder="{{ __('Total Harga') }}" value="{{ number_format($detail->total_harga,0,',','.')  }}">
                    </div>
                </div>
            </div>
            <div class="form-group row" id="intangible_asset" style="display: none">
                ...
                <div class="col-sm-12 col-md-8 parent-group">
                    <div class="input-group">
                        <input type="number" name="masa_pakai" class="form-control" placeholder="{{ __('Masa Pakai') }}" value="{{ $detail->masa_pakai }}">
                        <div class="input-group-append">
                            <span class="input-group-text">
                                Bulan
                            </span>
                        ...
                        <div class = "flex-fill">
                            <select class="base-plugin--select2-ajax form-control"
                                ...
                                @if($detail->masa_penggunaan)
                                    <option value={{$detail->masa_penggunaan}} selected>{{$detail->masa_penggunaan}}</option>
                                @endif
                            </select>
                        </div>
                        <div class="input-group-append">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-8 parent-group">
                     <input
                        ...
                        value="{{ $detail->tgl_pembelian->format('d/m/Y') }}">
                </div>
            </div>
            <div class="form-group row" id="tangible_asset">
