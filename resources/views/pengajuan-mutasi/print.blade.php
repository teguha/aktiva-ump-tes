...
<body class="page">
        ...
        <table style="border:none; width: 100%;">
            <tr>
                ...
                <td style="border:none;  text-align: center; font-size: 14pt;" width="auto">
                    <b>{{ __('PENGAJUAN MUTASI AKTIVA') }}</b>
    ...
    <main>
            ...
            <tr>
                <td style="border:none; width:55%;">
                    <table style="border:none; width:100%;">
                        ...
                        <tr>
                            <td style="border: none; width: 150px;">{{ __('Unit Kerja Asal') }}</td>
                            <td style="border: none; width: 10px; text-align: left;">:</td>
                            <td style="border: none; text-align: left;">{{ $record->fromStruct->name ?? "" }}</td>
                        </tr>
                    </table>
                </td>
                <td style="border:none; width:45%; text-align:right; float:right; position:relative; ">
                    <table style="border:none; width:100%;  position: relative; float:right;  width: auto !important;">
                        ...
                        <tr>
                            <td style="border: none; width: 150px;">{{ __('Unit Kerja Tujuan') }}</td>
                            <td style="border: none; width: 10px; text-align: left;">:</td>
                            <td style="border: none; text-align: left;">{{ $record->toStruct->name ?? "" }}</td>
                        </tr>
                    </table>
                </td>
            </tr>
        ...
        <hr>
        <br>
        <div style="text-align: justify;">Pengajuan mutasi aktiva ini dibuat pada tanggal {{ $record->created_at->translatedFormat('d F Y')}} dengan pengajuan sebagai berikut:</div>
        <br>
        <ol>
        ...
        <br>
        <div style="text-align: justify;">Demikian pengajuan mutasi aktiva ini dibuat untuk dipertimbangkan sebaik-baiknya dan penuh tanggung jawab.</div>
        <br><br>
