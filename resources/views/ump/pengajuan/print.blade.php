    ...
    <header>
        <table style="border:none; width: 100%;">
            <tr>
                ...
                <td style="border:none;  text-align: center; font-size: 12pt;" width="auto">
                    <b>{{ __('PENGAJUAN UANG MUKA PEMBAYARAN (UMP)') }}</b>
                    <div><b>{{ strtoupper(getRoot()->name) }}</b></div>
                </td>
                <td style="border:none; text-align: right; font-size: 12px;" width="140px">
                    <b></b>
                </td>
            </tr>
        </table>
                ...
                <td style="border:none; width:45%; text-align:right; float:right; position:relative; ">
                    <table style="border:none; width:100%;  position: relative; float:right;  width: auto !important;">
                        <tr>
                            ...
                            <td style="border: none; width: 10px; text-align: left;">:</td>
                            <td style="border: none; text-align: left;">
                            {{ $record->date_ump ?  $record->date_ump->translatedFormat('d F Y') : '' }}
                            </td>
                        </tr>
                    </table>
                </td>
        ...
        <table style="border: none; width: 100%">
            <tr>
                ...
                <td style="border: none;">
                    ...
                    {{ 'Rp. ' . number_format($record->nominal_pembayaran, 0, ',', '.') }}
                    </div>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="border: none;">
                    <div class="wysiwyg-content">
                    {{ $record->rekening->number }} ({{$record->rekening->owner->name}})
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td style="border: none;">
                    <div class="wysiwyg-content text-justify">
                        ...
                        @foreach ($record->files($module)->get() as $file)
                            <li>
