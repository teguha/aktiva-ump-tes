...
<body class="page">
        ...
        <table style="border:none; width: 100%;">
            <tr>
                ...
                <td style="border:none;  text-align: center; font-size: 14pt;" width="auto">
                    <b>{{ __('PEMBAYARAN UANG MUKA PEMBAYARAN (UMP)') }}</b>
    ...
    <main>
        ...
        <hr>
        <br>
        <div style="text-align: justify;">Perjanjian pengajuan Pembayaran UMP ini dibuat pada tanggal {{ $record->created_at->translatedFormat('d F Y')}} dengan pengajuan sebagai berikut:</div>
        <br>
        <table style="border: none; width: 100%">
            <tr>
                <td style="border: none;vertical-align: top; width: 170px;">{{ __('No Pembayaran UMP') }}</td>
                <td style="border: none; vertical-align: top; width: 10px;">:</td>
                <td style="border: none;">
                    <div class="wysiwyg-content">
                    {!! $record->id_ump_pembayaran ?? "" !!}
                    </div>
                </td>
            </tr>
            <tr>
                <td style="border: none;vertical-align: top; width: 170px;">{{ __('Tgl Pembayaran Ump') }}</td>
                <td style="border: none; vertical-align: top; width: 10px;">:</td>
                <td style="border: none;">
                    <div class="wysiwyg-content">
                    {{ $record->tgl_ump_pembayaran ?  $record->tgl_ump_pembayaran->format('d/m/Y') : '' }}
                    </div>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="border: none;">
                    <div class="wysiwyg-content">
                    {!! $record->tgl_jatuh_tempo ?  $record->tgl_jatuh_tempo->format('d/m/Y') : '' !!}
                    </div>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="border: none;vertical-align: top; width: 170px;">{{ __('Uraian Pembayaran UMP') }}</td>
                <td style="border: none; vertical-align: top; width: 10px;">:</td>
                <td style="border: none;">
                    <div class="wysiwyg-content">
                    {!! $record->uraian !!}
            ...
            <tr>
                <td style="border: none;vertical-align: top; width: 170px;">{{ __('Lampiran Pembayaran UMP') }}</td>
                <td style="border: none; vertical-align: top; width: 10px;">:</td>
                <td style="border: none;vertical-align: top;">
                    <div class="wysiwyg-content text-justify">
                        <ul style="padding-left: 15px;">
        ...
        <br>
        <div style="text-align: justify;">Demikian pengajuan Pembayaran UMP ini dibuat untuk dipertimbangkan sebaik-baiknya dan penuh tanggung jawab.</div>
        <br><br>
        @if ($record->approval($module)->exists())
            <div style="page-break-inside: avoid;">
                <div style="text-align: center;">{{ config('base.company.city') }},
