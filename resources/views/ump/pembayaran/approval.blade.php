                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-8 parent-group">
                                    <input type="text" class="form-control" placeholder="{{ __('No Pembayaran UMP') }}"
                                    value="{{ $record->id_ump_pembayaran}}" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-8 parent-group">
                                    <input type="text" class="form-control base-plugin--datepicker"
                                        ...
                                        value="{{ $record->tgl_ump_pembayaran ?  $record->tgl_ump_pembayaran->format('d/m/Y') : '' }}" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-8 parent-group">
                                    <input type="text" name="tgl_jatuh_tempo" class="form-control base-plugin--datepicker"
                                        ...
                                        value="{{ $record->tgl_jatuh_tempo ?  $record->tgl_jatuh_tempo->format('d/m/Y') : '' }}" disabled>
                                </div>
                            </div>
                        </div>
                    </div>
