                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-8 parent-group">
                                    <input type="text"  class="form-control base-plugin--datepicker"
                                        ...
                                        value="{{ $record->pengajuanUmp->date_ump->translatedFormat('d F Y') }}"disabled>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-8 parent-group">
                                    ...
                                    value="{{$record->pengajuanUmp->struct->name}}" disabled>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-8 parent-group">
                                    <select class="form-control base-plugin--select2-ajax rekening_id" data-url="{{ route('ajax.selectBankAccount', ['search' => 'all', ]) }}" placeholder="{{ __('Pilih Salah Satu') }}" disabled>
                                ...
                                <div class="col-sm-12 col-md-8 parent-group">
                                    <div class="input-group">
                                        <input type="text"
                                            ...
                                            placeholder="{{ __('Tgl Pengajuan UMP') }}" value="{{ $record->pengajuanUmp->tgl_jatuh_tempo ?  $record->pengajuanUmp->tgl_jatuh_tempo->format('d/m/Y') : '' }}" disabled>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-8 parent-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control text-right base-plugin--inputmask_currency" placeholder="{{ __('Nominal Pembayaran') }}" value="{{ $record->pengajuanUmp->nominal_pembayaran ?  $record->pengajuanUmp->nominal_pembayaran : '' }}" disabled>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-sm-12 col-md-8 parent-group">
                                    <div class="input-group">
                                        <input type="text"
                                            ...
                                            @if (isset($record->pengajuanUmp->perpanjanganUmp->tgl_perpanjangan_pembayaran))
                                                value="{{ $record->pengajuanUmp->perpanjanganUmp->tgl_perpanjangan_pembayaran ?  $record->pengajuanUmp->perpanjanganUmp->tgl_perpanjangan_pembayaran->format('d/m/Y') : '' }}"
                                            @elseif (isset($record->pengajuanUmp->tgl_pembayaran))
                                                value="{{ $record->pengajuanUmp->tgl_pembayaran ?  $record->pengajuanUmp->tgl_pembayaran->format('d/m/Y') : '' }}"
                                            @endif>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="card card-custom">
                <div class="card-body p-8">
                    <div class="row">
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group row">
                                <label class="col-sm-12 col-md-4 col-form-label">{{ __('No Pertanggungjawaban UMP') }}</label>
                                <div class="col-sm-12 col-md-8 parent-group">
                                    <input name="id_pj_ump" class="form-control" placeholder="{{ __('No Pertanggungjawaban UMP') }}"
                                    value="{{ $record->id_pj_ump}}" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group row">
                                <label class="col-sm-12 col-md-4 col-form-label">{{ __('Tgl  Pertanggungjawaban UMP') }}</label>
                                <div class="col-sm-12 col-md-8 parent-group">
                                    <input name="tgl_pj_ump" class="form-control base-plugin--datepicker"
                                        placeholder="{{ __('Tgl Pertanggungjawaban UMP') }}"
                                        value="{{ $record->tgl_pj_ump ?  $record->tgl_pj_ump->format('d/m/Y') : '' }}" disabled>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-12">
                            <div class="form-group row">
                                <label class="col-sm-12 col-md-2  col-form-label">{{ __('Lampiran Pertanggungjawaban UMP') }}</label>
                                <div class="col-sm-12 col-md-10  parent-group">
                                    @foreach ($record->files('ump.pj-ump')->where('flag', 'uploads')->get() as $file)
                                    <div class="progress-container w-100" data-uid="{{ $file->id }}">
                                        <div class="alert alert-custom alert-light fade show py-2 px-3 mb-0 mt-2 success-uploaded" role="alert">
                                            <div class="alert-icon">
                                                <i class="{{ $file->file_icon }}"></i>
