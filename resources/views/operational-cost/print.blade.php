        ...
        <ol>
            @foreach ($record->details()->orderBy('created_at', 'DESC')->orderBy('updated_at', 'DESC')->get() as $detail)
                <li>
                    <table style="border: none; width: 100%">
                        <tr>
                            <td style="border: none;vertical-align: top; width: 170px;">{{ __('Nama Biaya') }}</td>
                            <td style="border: none; vertical-align: top; width: 10px;">:</td>
                            <td style="border: none;">
                                <div class="wysiwyg-content">{{$detail->name ?? ''}}</div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td style="border: none;vertical-align: top; width: 170px;">{{ __('Biaya') }}</td>
                            <td style="border: none; vertical-align: top; width: 10px;">:</td>
                            <td style="border: none;">
                                <div class="wysiwyg-content">{{ 'Rp. ' . number_format($detail->cost,0,',','.') . ',-'  }}</div>
                            </td>
                        </tr>
                        <tr>
                            <td style="border: none;vertical-align: top; width: 170px;">{{ __('Tgl Pemesanan') }}</td>
                            <td style="border: none; vertical-align: top; width: 10px;">:</td>
                            <td style="border: none;">
                                <div class="wysiwyg-content">{{ $detail->tgl_pemesanan->translatedFormat('d F Y')  }}</div>
                            </td>
                        </tr>
                    </table>
                </li>
