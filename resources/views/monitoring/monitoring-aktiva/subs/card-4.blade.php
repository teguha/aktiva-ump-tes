                ...
                <tr data-key="{{ $loop->iteration }}">
                    ...
                    <td class="text-left parent-group">
                        <div class="input-group">
                            ...
                            <input type="text" name="details[{{ $loop->iteration }}][nominal]"  class="form-control text-right  base-plugin--inputmask_currency nominal-input-currency" placeholder="{{ __('Nominal') }}" value="{{number_format($dd->nominal)}}">
                        </div>    
                    </td>
                    <td class="text-left parent-group">
                        <div class="input-group">
                            ...
                            <input type="text" name="details[{{ $loop->iteration }}][pajak]"  class="form-control text-right base-plugin--inputmask_currency pajak-input-currency" placeholder="{{ __('Pajak') }}" value="{{number_format($dd->pajak)}}">
                        </div>  
                    </td>
                    <td class="text-left parent-group">
                        <div class="input-group">
