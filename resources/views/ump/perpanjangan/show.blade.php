            ...
            <div class="card card-custom">
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-8 parent-group">
                                    <input type="text" name="id_ump_perpanjangan" class="form-control" placeholder="{{ __('No Perpanjangan UMP') }}"
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-8 parent-group">
                                    <input type="text" name="tgl_ump_perpanjangan" class="form-control base-plugin--datepicker"
                                        data-options='@json([
                                            "endDate" => now()->format("d/m/Y") ])',
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group row">
                                <label class="col-sm-12 col-md-4 col-form-label">{{ __('Tgl Perpanjangan Pembayaran') }}</label>
                                <div class="col-sm-12 col-md-8 parent-group">
                                    <input name="tgl_perpanjangan_pembayaran" class="form-control base-plugin--datepicker"
                                        data-options='@json([
                                            "startDate" => now()->format("d/m/Y") ])'
                                        disabled
                                        placeholder="{{ __('Tgl Perpanjangan Pembayaran') }}"
                                        value="{{ $record->tgl_perpanjangan_pembayaran ?  $record->tgl_perpanjangan_pembayaran->format('d/m/Y') : '' }}">
                                </div>
                            </div>
                        </div>
                    </div>
