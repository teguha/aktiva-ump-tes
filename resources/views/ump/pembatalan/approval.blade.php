                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-8 parent-group">
                                    <input name="id_ump_pembatalan" class="form-control" placeholder="{{ __('No Pembatalan UMP') }}"
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-8 parent-group">
                                    <input name="tgl_ump_pembatalan" class="form-control base-plugin--datepicker"
                                        data-options='@json([
                                            "endDate" => now()->format("d/m/Y") ])',
