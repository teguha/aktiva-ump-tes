    ...
    <div class="col-sm-12 col-md-6">
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-md-8 parent-group">
                <input type="text" name="pengajuan_no_surat" class="form-control" placeholder="{{ __('No Surat Pengajuan UMP') }}"
                    value="{{ $pengajuan->no_surat }}" disabled>
            </div>
        </div>
    </div>
    <div class="col-sm-12 col-md-6">
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-md-8 parent-group">
                <input type="text" name="perihal" class="form-control" placeholder="{{ __('Perihal Pembayaran') }}"
                    value="{{ $pengajuan->perihal  }}" disabled>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-md-8 parent-group">
                <div class="input-group">
                    ...
                    <input type="text" name="nominal" class="form-control text-right" placeholder="{{ __('Nominal') }}"
                        value="{{ 'Rp '.number_format($pengajuan->aktiva->getTotalHarga(), 0, ',', '.') }}" disabled>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-md-8 parent-group">
               <input type="text" name="tgl_jatuh_tempo" class="form-control" placeholder="{{ __('Tgl Jatuh Tempo') }}"
                    value="{{ $record->show_tgl_jatuh_tempo ?? $record->getTglJatuhTempo()  }}" readonly>
            </div>
        </div>
    </div>
</div>
