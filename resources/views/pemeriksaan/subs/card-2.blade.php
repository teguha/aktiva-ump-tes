...
<div class="form-group row">
        ...
        <div class="col-md-10 parent-group">
            <textarea name="sentence_end" data-height="120" class="form-control base-plugin--summernote"
                placeholder="{{ __('Kalimat Penutu[') }}" {{in_array($page_action, ["show", "approval"]) ? "disabled" : ""}}>@if(!$record->sentence_end)<p>Demikian pengajuan pembelian aktiva ini dibuat untuk dipertimbangkan sebaik-baiknya dan penuh tanggung jawab.</p>@else {!! $record->sentence_end !!} @endif</textarea>
        </div>
    </div>