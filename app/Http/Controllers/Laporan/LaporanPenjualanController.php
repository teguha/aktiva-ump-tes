...
{
    protected $module = 'laporan.laporan-penjualan';
    protected $routes = 'laporan.laporan-penjualan';
    protected $views  = 'laporan.laporan-penjualan';
    protected $perms = 'laporan';

    const TYPE = [
        'pengajuan'           => [
            'route' => 'pelepasan-aktiva.penjualan',
            'scope' => 'gridStatusCompleted',
            'show'  => 'Pengajuan',
        ],
        'realization'           => [
            'route' => 'pelepasan-aktiva.pelaksanaan-penjualan',
        ...
        $this->prepare(
            [
                ...
                'breadcrumb' => [
                    ...
                    'Laporan Penjualan' => route($this->routes . '.index'),
                ],
            ]
        );
    }
            ...
            [
                'tableStruct' => [
                    'datatable_1' => [
                        ...
                        $this->makeColumn('name:pengajuan|label:Penjualan Aktiva|className:text-center'),
    ...
    public function grid(Request $request)
    {
        ...
        if (in_array($request->type, ['pengajuan', 'realization']) || ($request->date_start || $request->date_end || $request->struct_id)) {
            ...
            $records = PenjualanAktiva::$scope()->filters()->dtGet();
        }
