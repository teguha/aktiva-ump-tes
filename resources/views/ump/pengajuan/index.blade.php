...
@section('filters')
	<div class="row">
        <div class="col-12 col-sm-6 col-xl-3 pb-2 mr-n6">
            <input type="text" class="form-control filter-control" data-post="code" placeholder="{{ __('ID Pengajuan Aktiva/SGU') }}">
        </div>
        <div class="col-12 col-sm-6 col-xl-3 pb-2 mr-n6">
        ...
        <div class="col-12 col-sm-6 col-xl-3 pb-2 mr-n6">
            ...
            <option value="waiting confirmation">Menunggu Konfirmasi</option>
