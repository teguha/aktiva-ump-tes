...
@section('page-content')
    ...
    <div class="row mb-3">
        ...
        <div class="card-body">
            @csrf
            @include('pengajuan-mutasi.subs.card-1', ['record'=>$record])
        </div>
    </div>
</div>
</div>
...
<div class="col-sm-12">
    <div class="card card-custom">
        ...
        <div class="card-body p-8">
            @csrf
            @include('pengajuan-mutasi.subs.card-2', ['record'=>$record])
        </div>
            ...
            <div class="card-body p-8">
                <div class="form-group row">
                    ...
                    <div class="col-4 parent-group">
                        ...
                        <input name="code" class="form-control" placeholder="{{ __('ID Pelaksanaan') }}" value="{{ $record->realization->code??'' }}">
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10 parent-group">
                        <textarea name="description" class="form-control" placeholder="{{ __('Keterangan') }}">{!! $record->realization->description??'' !!}</textarea>
                    </div>
                </div>
                <div class="form-group row">
