...
@section('modal-body')
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-12 col-md-9 parent-group">
            <input type="text" class="form-control" placeholder="{{ __('Vendor') }}" value="{{ $record->struct->name }}"
                disabled>
        </div>
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-12 col-md-9 parent-group">
            <input type="text" id="tempHargaUnit" class="form-control" placeholder="{{ __('Harga per Unit') }}"
                disabled>
        </div>
    </div>
    <div class="form-group row">
        ...
        <div class="col-sm-12 col-md-9 parent-group">
            <input type="text" id="tempTglPembelian" class="form-control" placeholder="{{ __('Tgl Pembelian') }}"
                disabled>
        </div>
    </div>
@endsection
