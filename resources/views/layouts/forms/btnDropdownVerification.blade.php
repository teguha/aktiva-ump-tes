<div class="btn-group dropdown">
	...
	<div class="dropdown-menu dropdown-menu-right">
		<button type="button"
			...
			data-swal-title="Setujui Verifikasi UMP @if($record->aktiva) {{ $record->aktiva->code }}@else {{ $record->pengajuanSgu->code }}@endif?"
			@elseif(in_array($module,["termin"]))
			data-swal-title="Setujui Verifikasi Termin @if($record->aktiva) {{ $record->aktiva->code }}@else {{ $record->pengajuanSgu->code }}@endif?"
			@endif
