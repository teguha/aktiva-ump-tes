            ...
            <tr>
                ...
                <td class="text-left parent-group">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control text-right base-plugin--inputmask_currency" placeholder="{{ __('Total') }}" value="{{number_format($record->details()->sum('total'))}}" disabled>
                    </div>  
                </td>
            </tr>
        </tbody>
