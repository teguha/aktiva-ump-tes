...
@section('modal-body')
	<div class="form-group row">
		<label class="col-sm-9 col-form-label">{{ __('Parent') }}</label>
	...
	<div class="form-group row">
		<label class="col-sm-9 col-form-label">{{ __('Nama') }}</label>
		<div class="col-sm-3 parent-group">
			<input type="text" value="{{ $record->name }}" class="form-control" placeholder="{{ __('Nama') }}" disabled>
		</div>
	</div>
	{{--<div class="form-group row">
		<label class="col-sm-9 col-form-label">{{ __('Status') }}</label>
		<div class="col-sm-3 parent-group">
